...
COUNTER			; COUNTER LOOP
	LDR R3, R0, #0  ; PUT VALUE AT X4005 INTO R3
	LD R7, MASK1
...
DIVIDEONE	;
	ADD R6, R6, #1	; COUNTER
	ADD R0, R0, #-2	; DECREMENTER
BRP DIVIDEONE	; GO BACK UNTIL DOWN TO 0
ADD R5, R6, #-1	; R5= R6-1
LD R2, X	; R2= X4005
ADD R2, R2, R5	; R2= X4005+R5
AND R1, R1, #1	; CHECK ODD OR EVEN
BRZ EVEN	; IF Z, EVEN
LDR R4, R2, #0
AND R4, R4, R7
BRNZP MEDIAN
